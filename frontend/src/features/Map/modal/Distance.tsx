            ...
            <main>
                <div className={style.configForm}>
                    <Slider style={{
                        width : 250,
                        margin : "0 auto"
                    }} marks={dots} step={500} included={false} defaultValue={dist} min={500} max={2500} tipFormatter={fomatter} onChange={handleChangeRange}/>
                </div>
                <div style={{
                    display : "flex",
                    ...
                    onClick={handleSaveDist}>확인</button>
                </div>
            </main>
            </section>
        ) : null}
