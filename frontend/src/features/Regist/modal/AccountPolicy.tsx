              ...
              <main>
                ...
                <br/>
                  ...
                  <br/>
                    ...
                    이용자란 본 약관에 동의하고 회사가 제공하는 서비스 이용
                    자격을 부여 받은 자를 의미합니다. 3) 방장이란 파티룸을
                    개설하고 운영하는 이용자를 의미합니다. 4) 탈퇴란 이용자가
                    서비스 이용 계약을 종료하는 의사표시를 말합니다.                <br/>
 2. 이
...
4. 변경된 약관은 적용일 및
                    ...
                    효력이 발생됩니다.                 <br/>
5. 이용자는 변경된 약관에 동의하지 않을
                    권리가 있으며, 변경된 약관에 동의하지 않을 경우에는 서비스
                    이용을 중단하고 탈퇴할 수 있습니다.                 <br/>
6. 변경된 약관 공지 시
                    이용자가 회사에 명시적으로 거부의 의사표시를 하지 않거나
 ...
 2. 청소년(만 19세
                  ...
                  <br/>
                    ...
                    있습니다.                 <br/>
2. 회사는 서비스에 가입한 이용자에게 닉네임,
                    고유아이디가 포함된 계정을 제공합니다.                 <br/>
3. 회사는 계정 정보를
...
4. 이용자는 자신의 계정을 성실히 관리하여야 합니다. 이용자가
                    ...
                    행사와 의무의 이행을 신의에 따라 성실하게 수행합니다.                <br/>
 2.
                    회사는 계속적이고 안정적인 서비스의 제공을 위하여 최선의
                    노력을 다합니다.                 <br/>
3. 회사는 이용자들이 서비스를 편리하게
                    이용할 수 있도록 최선의 노력을 다합니다.                 <br/>
4. 회사는 이용자가
