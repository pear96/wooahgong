        ...
        <section className={style.modalForm} onClick={handleStopEvent} onKeyDown={onClose} role="button" tabIndex={0}>
          ...
          <main>
            <div className={style.configForm}>
              ...
              제1조 목적
              <br />
              이 약관은 짠해(이하 “회사”)가 제공하는 “Jjanhae”와 관련하여 회사와 이용자 간의 권리와 의무 및 필요한
              사항을 정하는데 그 목적이 있습니다.
              <br />
              <br />
              제 2 조 (용어의 정의)
              <br />
              1. 이 약관에서 사용하는 용어의 정의는 다음과 같습니다. 1) Jjanhae 랜선 술자리 서비스(이하 서비스 ) 란
              PC에서 카메라와 화면 공유를 통해 짠해만의 컨텐츠를 이용하여 실시간으로 다양한 사람들과 소통할 수 있는
              플랫폼입니다. 2) 이용자란 본 약관에 동의하고 회사가 제공하는 서비스 이용 자격을 부여 받은 자를 의미합니다.
              3) 방장이란 파티룸을 개설하고 운영하는 이용자를 의미합니다. 4) 탈퇴란 이용자가 서비스 이용 계약을 종료하는
              의사표시를 말합니다. <br />
