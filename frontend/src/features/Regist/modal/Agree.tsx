          ...
          {open ? (
            <section className={style.modalForm} onClick={handleStopEvent} onKeyDown={onClose} role="button" tabIndex={0}>
              ...
              <main>
                ...
                [ 우.아.공(우리만 아는 공간) ] 은(는) 「개인정보 보호법」 제30조에 따라
                    ...
                    <br/>
                    제1조(개인정보의 처리 목적)
                    우.아.공(우리만 아는 공간)은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
                    ...
                    <br/>
                    <br/>
                    제2조(개인정보의 처리 및 보유 기간) ① 우.아.공(우리만 아는 공간)은(는) 법령에
                    ...
                    <br/><br/>
                    제3조(개인정보의 제3자 제공)
                    ① &lt; 우.아.공(우리만 아는 공간) &gt;은(는) 개인정보를 제1조(개인정보의 처리
                    목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의,
                    법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에
                    해당하는 경우에만 개인정보를 제3자에게 제공합니다. ② &lt;
                    우.아.공(우리만 아는 공간) &gt;은(는) 다음과 같이 개인정보를 제3자에게 제공하고
                    있습니다. 
                    <br/>
                    1. 개인정보를 제공받는 자 : 제공받는 자의 개인정보
                    이용목적 : 제공받는 자의 보유.이용기간: 
                    <br/><br/>
                    제4조(개인정보처리
                    위탁) ① &lt; 우.아.공(우리만 아는 공간) &gt;은(는) 원활한 개인정보 업무처리를
                    위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다. 
                    <br/>1.
                    위탁받는 자 (수탁자) : 위탁하는 업무의 내용 : 위탁기간 : ②
                    &lt; 우.아.공(우리만 아는 공간) &gt;은(는) 위탁계약 체결시 「개인정보 보호법」
                    ...
                    행사방법) ① 정보주체는 우.아.공(우리만 아는 공간)에 대해 언제든지 개인정보
                    열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
                    ② 제1항에 따른 권리 행사는 우.아.공(우리만 아는 공간)에 대해 「개인정보
                    보호법」 시행령 제41조제1항에 따라 서면, 전자우편,
                    모사전송(FAX) 등을 통하여 하실 수 있으며 우.아.공(우리만 아는 공간)은(는) 이에
                    ...
                    우.아.공(우리만 아는 공간)은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
                    요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나
                    정당한 대리인인지를 확인합니다. 
                    <br/><br/>
                    제6조(처리하는 개인정보의
                    항목 작성) ① &lt; 우.아.공(우리만 아는 공간) &gt;은(는) 다음의 개인정보 항목을
                    처리하고 있습니다. &lt; 홈페이지 회원가입 및 관리 &gt;
                    필수항목 : 이메일, 로그인ID, 서비스 이용 기록 선택항목 :
                    제7조(개인정보의 파기) ① &lt; 우.아.공(우리만 아는 공간) &gt; 은(는) 개인정보
                    ...
                    같습니다. 
                    <br/>1. 파기절차 &lt; 우.아.공(우리만 아는 공간) &gt; 은(는) 파기 사유가
                    발생한 개인정보를 선정하고, &lt; 우.아.공(우리만 아는 공간) &gt; 의 개인정보
                    보호책임자의 승인을 받아 개인정보를 파기합니다.
                    <br/><br/>
                    제8조(개인정보의 안전성 확보 조치) &lt; 우.아.공(우리만 아는 공간) &gt;은(는)
                    개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
                    있습니다. 
                    <br/>1. 정기적인 자체 감사 실시 개인정보 취급 관련
                    안정성 확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고
                    있습니다. 제9조(개인정보 자동 수집 장치의 설치•운영 및
                    거부에 관한 사항) ① 우.아.공(우리만 아는 공간) 은(는) 이용자에게 개별적인
                    ...
                    보호책임자) ① 우.아.공(우리만 아는 공간) 은(는) 개인정보 처리에 관한 업무를
                    ...
                    정보주체께서는 우.아.공(우리만 아는 공간) 의 서비스(또는 사업)을 이용하시면서
                    발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에
                    관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
                    있습니다. 우.아.공(우리만 아는 공간) 은(는) 정보주체의 문의에 대해 지체 없이
                    답변 및 처리해드릴 것입니다. 제11조(개인정보 열람청구)
                    정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람
                    청구를 아래의 부서에 할 수 있습니다. &lt; 우.아.공(우리만 아는 공간) &gt;은(는)
